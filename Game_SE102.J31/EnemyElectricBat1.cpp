...
EnemyElectricBat1::EnemyElectricBat1()
{
	tag = ENEMY;
	type = ELECTRICBAT;

	//type 1: Doi treo nguoc
	animations[STANDING] = new Animation(ENEMY, 52);
	animations[ACTIVE] = new Animation(ENEMY, 54, 55, 300);
...
void EnemyElectricBat1::UpdateDistance(float dt)
{
	switch (stateName)
	{
	case STANDING:
...
void EnemyElectricBat1::ChangeState(State StateName)
{
